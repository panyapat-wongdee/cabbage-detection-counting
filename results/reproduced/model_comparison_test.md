# Reproduced model comparison (test split)
...
|---|---|---|---|---|
| faster_rcnn* | torchvision | paper_model | 0.9739 | 0.6811 |
| ssd* | torchvision | paper_model | 0.9497 | 0.5920 |
| retinanet* | torchvision | paper_model | 0.9607 | 0.6779 |
| fcos* | torchvision | paper_model | 0.9732 | 0.7133 |
...
| ssdlite* | torchvision | supplementary_unreported | 0.8304 | 0.4781 |
...
|---|---|---|---|---|---|---|---|---|---|
| faster_rcnn* | 3419 | 3535 | 3307 | 228 | 112 | +0.0339 | 0.0645 | 0.0328 | 0.9511 |
| ssd* | 3419 | 3223 | 3087 | 136 | 332 | -0.0573 | 0.0422 | 0.0971 | 0.9295 |
| retinanet* | 3419 | 3701 | 3264 | 437 | 155 | +0.0825 | 0.1181 | 0.0453 | 0.9169 |
| fcos* | 3419 | 3544 | 3329 | 215 | 90 | +0.0366 | 0.0607 | 0.0263 | 0.9562 |
...
| ssdlite* | 3419 | 1892 | 1851 | 41 | 1568 | -0.4466 | 0.0217 | 0.4586 | 0.6970 |
